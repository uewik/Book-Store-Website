...
//		boolean isCreditCardExpirationError = false;

		if (exception instanceof ApiException.ValidationFailure) {
			status = Response.Status.BAD_REQUEST;

//			if (Objects.equals(((ApiException.ValidationFailure) exception).getFieldName(), "CCExpiryDate"))
//				isCreditCardExpirationError = true;
		}
